...
import com.example.handPick.entity.Country; // Adjusted import for Country entity
...
public interface CountryRepository extends JpaRepository<Country, Integer> {
    // This interface automatically provides CRUD operations for the Country entity.
    // Spring Data REST will expose these operations at /api/countries by default.
}